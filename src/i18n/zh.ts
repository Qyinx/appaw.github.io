  ...
  psaGradingPage: {
    ...
    batchBoard: {
      ...
      phaseHints: {
        ...
        atPsa: '本輪已截止收卡',
        returning: '成績已出或回程中',
        pickup: '請到 138 Arena 取件',
      },
      closesIn: '剩餘 {days} 天 {hours} 小時',
      closesInHours: '剩餘 {hours} 小時 {minutes} 分',
      closesInMinutes: '剩餘 {minutes} 分',
      intakeClosed: '已截止收卡',
      noCutoff: '未設定截止',
      closingSoon: '即將截止',
      bookCta: '預約交卡',
      trackCta: '查詢進度',
      emptyTitle: '目前沒有開放收卡的批次',
      emptyBody: '先預約時段 — 交卡當日我們會開下一輪 BAT。',
      emptyCta: '預約交卡',
      loading: '載入批次中…',
      error: '無法載入批次看板。',
      retry: '重試',
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            {
              q: '什麼時候可以取卡？',
              a: '當進度顯示「可於 138 Arena 取件」以及收到我們WhatsApp/Email的取件通知時，發出通知日計起14日內可到 138 Arena 取回卡牌。',
            },
            {
              q: '若發出通知日起的14日後未取卡，會怎樣？',
              a: '發出通知日起的14日後未有取回的卡片將會被視為放棄該卡片的擁有權，我們會向客戶發出「放棄取回卡片通知」，並不會退還任何費用。',
            },
            {
  ...
  psaGradingTrack: {
    ...
    results: {
      ...
      items: {
        ...
        pending: '待定',
        image: '圖片',
        viewImage: '查看 {name} 的圖片',
        closePreview: '關閉預覽',
        frontLabel: '正面',
        backLabel: '背面',
        openCertLookup: '在新分頁開啟 PSA 證書 {cert}',
      },
    },
  },
