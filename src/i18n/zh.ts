...
export const zh: Translations = {
  ...
  about: {
    ...
    story: {
      title: '我們的故事',
      content: 'Appaw Store 由熱愛收藏的玩家創立，我們深知保護珍貴卡片的重要性。我們以簡單的使命開始：為收藏家提供最佳的卡片保護解決方案和寄售服務。',
    },
    mission: {
      title: '我們的使命',
      content: '成為卡片保護和寄售服務領域最值得信賴的品牌，幫助收藏家保存和增值他們的珍貴收藏。',
    },
    values: {
      title: '我們的價值觀',
      quality: {
  ...
  business: {
    ...
    consignment: {
      title: '寄售商店',
      description: '讓我們為您銷售卡片。我們負責上架、拍攝和客戶服務。',
      features: [
        '專業拍攝和上架',
        '具競爭力的佣金費率',
        '安全的存儲和處理',
      ...
      steps: [
        {
          icon: 'package',
          title: '寄送卡片',
          description: '將您的評級卡片安全寄送給我們。',
        },
        {
          icon: 'camera',
          title: '我們上架',
          description: '專業拍攝並在多個平台上架。',
        },
        {
          icon: 'store',
          title: '我們銷售',
          description: '我們處理所有客戶諮詢和交易。',
        },
        {
          icon: 'wallet',
          title: '收取款項',
          description: '卡片售出後即可收款。',
        },
      ],
    },
  },
