    ...
    <section className="panel p-8 md:p-10 border-l-[3px] border-l-accent-brand" aria-labelledby="guide-cta">
      ...
      <div className="flex flex-wrap gap-3">
        <LocalLink
          ...
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-accent-brand text-accent-structural border border-accent-brand font-semibold text-sm hover:opacity-90 transition-opacity duration-150"
        >
          {cta.primary.label}
