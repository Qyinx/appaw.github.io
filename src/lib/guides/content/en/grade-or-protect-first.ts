...
const guide: GuideContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'When to Submit Raw Cards to PSA',
      paragraphs: [
    ...
    {
      id: 'bottom-line',
      title: 'Bottom Line: Offense and Defense Together',
      paragraphs: [
        'Raw submission and slab protection sit in different phases but serve one collection. Pick the right move at the right moment — you cut risk and keep both upside and long-term value.',
        'Beginner or investor, judgment and protection decide outcomes. Both paths end the same way: a verified cert inside a protected slab. The only fork is whether you paid grading fees yourself or bought the finished label from someone else.',
      ],
    },
  ],
  cta: {
