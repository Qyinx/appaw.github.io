...
const guide: GuideContent = {
  ...
  cta: {
    title: '邊距達標？安排提交鑑定',
    body: '置中確認達標後，即可考慮提交鑑定。香港藏家如欲使用 PSA評級代送鑑定，可先於網站預約，再到銅鑼灣 138 Arena 當面辦理。138 Arena 負責場務及收費；Appaw Store 負責評級代送鑑定及跟進，並可調整最終應付金額。現場初步檢視僅供參考，最終分數由 PSA 決定。鑑定卡取回後，可加裝磁吸防護硬殼。',
