...
const guide: GuideContent = {
  ...
  badge: '鑑定規格',
  lead:
    'PSA 9 是最代價高昂的等級。不是卡片品相差，而是置中僅差幾個百分點，鑑定費用卻照常支付。支付鑑定費用前，先測量邊距。這是成本最低的篩選步驟。',
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'PSA 於 2025 年初將 Gem Mint 正面由 60/40 收緊至 55/45。偏差達 60/40 通常只能拿 PSA 9，即使邊角、表面極佳。評級員有最終裁量權，眼感（Eye Appeal）出色時可能對微小偏差網開一面，但熱門新秀卡或高價卡通常把標準收得更嚴。',
        '置中本身不保證 PSA 10，角位、邊緣、表面仍計分，但它是提交鑑定或購買 PSA 10 前，最快可從照片完成的檢查。',
      ],
      specs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '現代印刷雖然進步，裸卡切割仍易偏移，TCG 卡（如寶可夢）邊框較窄，置中問題比傳統運動卡更常見。置中不良是裸卡提交鑑定後掉到 PSA 9 的最常見原因之一。',
        '實務上，正面是等級限制因素。收藏家很少見到 65/35 正面仍達 PSA 10 的案例，購買或提交鑑定前，務必拍攝並量度正面/背面。',
      ],
    },
    {
      id: 'how-to-measure',
    ...
    },
    {
      ...
      paragraphs: [
        '各等級置中門檻與市場影響對照如下。提交鑑定前先對照目標等級，避免為 PSA 10 價格付給 PSA 9 品相。',
      ],
      table: {
    ...
    },
    {
      ...
      title: '常見置中問題與避免方法',
      paragraphs: [
        '出廠切割偏移：出廠切割不均。購買裸卡時即用置中工具嚴格檢查，請勿等待提交鑑定後才發現。',
        '印刷偏移：圖案本身不在卡片中心。需多角度觀察整體眼感，邊框數字達標但圖案偏了仍可能降分。',
        'TCG 特殊性：寶可夢等窄邊框設計，置中要求更嚴苛，55/45 容錯更小。',
        '提交前清單：只送置中達標且邊角、表面、邊緣皆優的裸卡。香港藏家可經 [138 Arena 代送鑑定](/business/psa-grading/) 面交評估卡況及提交鑑定及取件，並查看批次現有進度。記錄測量數據與照片作佐證。',
      ],
    },
    {
      id: 'practical-tips',
      ...
      paragraphs: [
        '裸卡篩選流程：先看置中 → 再看邊角與表面。若正面任一軸超過 55/45，先評估 PSA 9 是否仍具經濟意義，再決定批量提交鑑定或高價購買。',
        '網上購買鑑定卡：要求平整高解析正面/背面掃描，用 [置中計算器](/tools/card-centering/) 鑑定卡模式篩選。傾斜拍攝的鑑定卡照片會隱藏偏斜。',
        '提交鑑定時機：選積壓不嚴重時段，申報合理保險價值。若置中是唯一弱點且其他條件極佳，可考慮 [Regrade](/guides/regrade-or-reholder/)，需承擔降分風險。',
        '拿到 PSA 10 後：立即加裝 [磁吸鑑定卡保護殼](/products/psa-protectors/)，避免展示或攜帶時刮花外殼、影響轉售。詳見 [裸卡到受保護鑑定卡：提交鑑定後加裝保護殼](/guides/grade-or-protect-first/)。',
      ],
    },
    {
      id: 'bottom-line',
      title: '先測量邊距，再支付鑑定費用',
      paragraphs: [
        'PSA 10 置中（正面 55/45、背面 75/25）有一定容忍度，但要穩定達 PSA 10，仍需近乎完美的裸卡品相。提交鑑定與購買 PSA 10 前，先用工具量度正面/背面邊距。',
      ],
    },
  ],
  faq: [
