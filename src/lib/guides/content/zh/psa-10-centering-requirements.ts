...
const guide: GuideContent = {
  ...
  badge: '鑑定規格',
  lead:
    'PSA 9 是最代價高昂的等級。不是卡片品相差，而是置中僅差幾個百分點，送鑑費卻照常支付。付送鑑費前，先測量邊距——這是最便宜的篩選步驟。',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '實務上，正面是等級限制因素。收藏家很少見到 65/35 正面仍達 PSA 10 的案例，購買或送鑑前，務必拍攝並量度正面/背面。',
      ],
    },
    {
      id: 'how-to-measure',
    ...
    },
    {
      ...
      title: '先測量邊距，再付送鑑費',
      paragraphs: [
        'PSA 10 置中（正面 55/45、背面 75/25）有一定容忍度，但要穩定達 PSA 10，仍需近乎完美的裸卡品相。送鑑與購買 PSA 10 前，先用工具量度正面/背面邊距。',
      ],
    },
  ],
  faq: [
  ...
  midCta: {
    ...
    body: '平面掃描或賣家照片即可。比對正面/背面是否達 55/45 與 75/25，再決定是否付送鑑費。',
