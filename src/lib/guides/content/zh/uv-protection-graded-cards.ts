  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        '畫框行業常以 Tru Vue / PPFA 標準為參考：300–380 nm 波段阻隔 97%，是博物館裝裱基準。Appaw 展示玻璃標示 400 nm 以下 >95%，涵蓋鑑定卡全像與鍍鉻層的褪色波段，表述與產品規格一致。',
      ],
      specs: [
    ...
    },
    {
      ...
      title: '香港及沿海濕度',
      paragraphs: [
        '鑑定殼封住了卡，但不是防潮箱。多年後濕氣仍會緩慢滲透 holder。香港室內相對濕度大部分時間約 70–80%。超過 60% RH 時，開架存放的鑑定卡可能出現標籤起霧或全像面波紋。',
        '潮濕城市的收藏家通常以 45–55% RH 電子乾燥櫃存放磚堆。此範圍保持卡紙穩定，又不會過乾令邊角反捲。穩定比追求完美數值重要：一週內 40% 到 75% 的波動，比穩定 52% 傷害更大。',
        '封閉盒內放矽膠乾燥劑對少量磚有效，但需定期再生。磚堆增多後，小型防潮箱（20–40 公升，可容納數十塊磚）是常見升級。',
      ],
      specs: [
        { label: '最佳儲存濕度', value: '45–55%' },
    ...
    },
    {
      ...
      title: '日常可做的習慣',
      paragraphs: [
        '鑑定卡直立放在有襯墊的架子上，勿平放堆疊十層。重量加濕度變化會壓力底部磚的外殼。',
