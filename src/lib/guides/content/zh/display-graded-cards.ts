...
const guide: GuideContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '鑑定卡護套 + 活頁夾：為每塊鑑定卡套上專用透明護套後放入多孔活頁冊，便利日常翻閱防塵，建議挑選帶有軟質內襯的活頁頁面，防止卡磚互相摩擦。',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '層架排列原則：鑑定卡應直立排列，外殼之間至少保持 5 mm 間距。請勿將裸磚堆疊超過十層，下層外殼的接合處容易因重力與微震而受損。',
      ],
    },
    {
  ...
  faq: [
    { q: '在家展示鑑定卡最好的方式是？', a: '大批量日常收納宜用護套加活頁夾；重點收藏的卡牌宜放入 35PT 磁吸防紫外線玻璃殼，再置於桌面或層架展示。' },
    { q: '鑑定磚可以平放堆疊嗎？', a: '請勿將未加外層保護殼的鑑定卡長時間平放堆高。宜直立排列，外殼之間至少保留 5 mm 間距，以免接合處受壓。' },
    { q: '窗邊光線會令鑑定磚褪色嗎？', a: '會。即使已加外層保護殼，窗邊直射陽光仍會累積紫外線傷害。應選用抗紫外線玻璃或壓克力，並將鑑定卡避開陽光直射的路徑。' },
  ],
  midCta: {
