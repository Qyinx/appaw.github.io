  ...
  sections: [
    {
      ...
      bridge: '大量收藏從低成本收納開始；追卡與高價單張再升級硬殼。',
    },
    {
      id: 'basic-display',
      ...
      paragraphs: [
        ...
        '單張展示架：亞克力或塑料展示架，適合書桌或展示櫃上直立、平放追卡（如 PSA 10 新秀卡）。',
    ...
    },
    {
      ...
      title: '進階與大型收藏展示',
      paragraphs: [
        '展示櫃與展示盒：多張鑑定卡展示盒具防塵與 UV 功能；木質或玻璃展示櫃適合客廳、收藏室，搭配低色溫、無紫外線的 LED 照明；抽屜式收納櫃適合大量收藏、分類管理。',
        ...
        '層架展示：鑑定卡磚直立排列，外殼之間至少留 5 mm 間距。切勿裸磚平放堆疊十層以上，重量與震動可能損害內殼接合位。',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        '日常維護：減少裸手觸摸，僅拿護套或外殼邊緣；以微濕軟布清潔外殼，勿以紙巾擦拭塑料；輕微磨損考慮 [PSA Reholder](/guides/regrade-or-reholder/)。',
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ['日常收納', '護套 + 活頁夾', '中小型', '高'],
          ['追卡單張展示', '磁吸硬殼 / 展示架', '任何規模', '極高'],
          ['大量陳列', '展示櫃 / 展示盒', '大型', '高'],
          ['牆面展示', '浮動相框 + UV 板', '追卡', '中高'],
        ],
      },
    },
    {
      ...
      paragraphs: [
        ...
        '新手起步：從護套 + 活頁夾開始，追卡逐步升級磁吸硬殼或展示櫃。購買前確認貼合度，標準 35PT PSA/CGC 外徑，詳見 [如何選擇 35PT 鑑定卡保護殼](/guides/choose-35pt-slab-protector/)。',
