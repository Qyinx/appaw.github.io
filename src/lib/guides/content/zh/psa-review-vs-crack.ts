  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '這看似完美，但同樣面臨定錨效應與「隔殼觀火」的限制。評級員隔著厚重的 BGS 外殼很難精確判斷表面微小刮痕，因此在保守起見下，往往不會給出 10 分。因此，許多進階藏家在跨評時，仍會選擇先自行破殼，以獲取最公平的裸卡審視。若您已決定以裸卡重新提交，可透過 Appaw PSA 評級代送於 138 Arena 面交，由專人協助批次轉送並於網上查看現有進度。',
      ],
    },
  ],
  faq: [
    ...
    {
      q: '香港可以透過 PSA 評級代送辦理破殼重送或跨評嗎？',
      a: '可以。香港藏家可於銅鑼灣 138 Arena 當面辦理。138 Arena 負責場務及收費；Appaw Store 完成點收與初步檢視，再將卡牌併入 PSA 評級代送批次。該檢視僅供參考，最終分數由 PSA 決定。破殼前先做初步檢視，有助判斷升分期望值是否值得承擔降級風險。',
    },
  ],
  midCta: {
    afterSectionId: 'expected-value-math',
    title: '破殼前，先做現場卡況初步評估',
    body: '香港藏家可親臨 138 Arena，由 Appaw 完成點收與初步檢視，核對置中、表面與邊角。該檢視僅供參考，最終分數由 PSA 決定。其後再決定是否破殼重送。138 Arena 負責場務及收費；Appaw Store 負責評級代送及跟進。',
    primary: { label: 'PSA 評級代送', href: '/business/psa-grading/' },
    secondary: { label: '免費置中工具', href: '/tools/card-centering/' },
  },
  cta: {
    title: '重送前先評估，香港可面交辦理評級代送',
    body: 'PSA 10 現時要求正面 55/45 的置中比例。決定破殼重送前，請先使用免費置中工具測量邊距。香港藏家如欲提交鑑定，可先於網站預約，再到銅鑼灣 138 Arena 當面辦理。138 Arena 負責場務及收費；Appaw Store 負責評級代送及跟進，並可調整最終應付金額。現場初步檢視僅供參考，最終分數由 PSA 決定，以免白白付出鑑定費用。',
    primary: { label: 'PSA 評級代送', href: '/business/psa-grading/' },
    secondary: { label: '免費置中工具', href: '/tools/card-centering/' },
  },
