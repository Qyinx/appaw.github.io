...
const guide: GuideContent = {
  ...
  badge: '流程',
  lead:
    '「先提交鑑定還是先加殼」並非二選一：裸卡無法加 35PT 保護殼，兩者屬不同時間點的連續步驟。路徑匯於鑑定卡加外層保護殼；裸卡提交鑑定門檻約 $25+，PSA 10 預期售價須達裸卡 2–4 倍。',
  published: '2026-06-07',
  updated: '2026-07-12',
  readTime: '9 分鐘',
  heroImage: '/images/background/grade-or-protect-first.png',
  heroSpecs: [
    { label: '提交鑑定門檻', value: '裸卡 $25+，預期 2–4× 溢價' },
    { label: '階段一', value: '裸卡：評估是否提交鑑定' },
    { label: '階段二', value: '鑑定卡：加外層保護殼' },
    { label: '完整路徑', value: '裸卡 → 提交鑑定 → 保護殼' },
  ],
  sections: [
    {
      id: 'why-both-matter',
      title: '提交鑑定與加殼不是二選一',
      paragraphs: [
        '搜尋「先提交鑑定還是先保護」常令人以為須在兩者間擇一。實務上兩者無衝突：裸卡階段決定是否支付鑑定費用；鑑定卡到手或購入後，下一步是加外層保護殼。同一張卡不會在同一時間點面臨此抉擇。',
        '常見疏漏是提交鑑定回來後未即時加殼，或把兩個獨立問題混為一談。路徑 A：自有裸卡，經提交鑑定取得鑑定卡；路徑 B：直接購入鑑定卡。兩條路徑於加保護殼後匯合。',
      ],
      bridge: '先談路徑 A 的裸卡經濟學。鑑定卡一到手，就該加外層保護殼。',
    },
    {
      id: 'when-to-submit-raw',
      title: '路徑 A：裸卡何時值得提交鑑定',
      paragraphs: [
        '提交裸卡旨在提升市值，並非每張卡都值得支付鑑定費用。送錯則費用白白付出成本，或標籤分數拉低轉售價。',
        ...
        '不宜送：裸卡低於 $20–25，鑑定費用會耗盡全部溢價空間；邊角磨損、表面刮痕明顯，多半 PSA 8 以下；PSA 積壓嚴重或暫停服務；純收藏、無轉售打算。',
    ...
    },
    {
      ...
      paragraphs: [
        '鑑定殼封裝了卡面，塑料外殼仍會刮擦、霧化、龜裂，展示價與買家信心皆受影響。加殼是用已付的鑑定費用守住標籤價值。',
    ...
    },
    {
      ...
      title: '實務步驟清單',
      paragraphs: [
        '路徑 A：測量置中 → 放大鏡檢查表面與邊角 → 經濟合理則提交鑑定 → 取回後於 [psacard.com/cert](https://www.psacard.com/cert) 核對證書 → 加 [外層保護殼](/products/psa-protectors/) → 展示、交易或寄送。',
        '路徑 B：核對賣家照片與 PSA 認證資料庫 → 收貨即加外殼 → 記錄購入價與證書編號。',
        '高價值卡：先做成本效益分析。香港藏家可到合作店舖 [138 Arena](/business/psa-grading/)（銅鑼灣謝斐道522號1/F）面交評估卡況及提交鑑定及取件，代送 PSA 並提供查看現有進度。鑑定費用用、政策與週期以 [PSA 官網](https://www.psacard.com) 為準。',
        '新手：先以低中價位卡練熟提交鑑定與保護流程，再處理夢幻級卡牌。',
      ],
    },
    {
      id: 'bottom-line',
      title: '結語：兩條路，同一終點',
      paragraphs: [
        '兩條路徑終點相同：證書已核對、已加外殼的鑑定卡。差別只在於鑑定費用由您支付，抑或向他人購下已完成標籤的鑑定卡。',
      ],
    },
  ],
  faq: [
    {
      q: '提交鑑定與加保護殼是什麼關係？',
      a: '先後順序，非二選一。手上有裸卡且經濟與品相合理時提交鑑定；鑑定卡到手或購入後應立即加外層保護殼。',
    },
    {
      q: '什麼時候值得付 PSA 鑑定費用？',
  ...
  midCta: {
    ...
    body: '支付鑑定費用前，用免費工具核對置中與邊距。鑑定卡已到手則直接選保護殼。',
    primary: { label: '免費置中計算器', href: '/tools/card-centering/' },
    secondary: { label: '鑑定卡保護殼', href: '/products/psa-protectors/' },
  },
  cta: {
    title: '鑑定卡到手，加裝外層保護殼',
    body: '保護已有或剛收到的鑑定卡。裸卡提交鑑定前，先用免費置中工具評估是否值得付費；香港藏家可到 138 Arena 面交評估卡況及提交鑑定及取件。',
