...
const guide: GuideContent = {
  ...
  heroSpecs: [
    { label: '裸卡提交', value: '增值策略 — 進攻' },
    { label: '鑑定卡保護', value: '保值策略 — 防守' },
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '不建議提交：裸卡價值低於 20–25 美元的低價卡，評級費用容易超過升值空間；品相已有明顯邊角磨損、表面刮痕等瑕疵，容易拿到 PSA 8 以下；PSA 提交 backlog 嚴重或服務暫停期間；純粹個人長期收藏，無轉售意圖。',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '高價值卡特別注意：務必進行詳細成本效益分析，必要時透過 PSA 授權經銷商或合作平台提交。PSA 評級費用、政策與提交狀況會隨時間變化，以 [PSA 官網](https://www.psacard.com) 為準。',
